...
[![CI](https://github.com/step-security/auto-approve-action/actions/workflows/ci.yml/badge.svg?event=push)](https://github.com/step-security/auto-approve-action/actions/workflows/ci.yml)

**Name:** `step-security/auto-approve-action`
...
jobs:
  build:
    ...
    permissions:
      pull-requests: write
    steps:
      - uses: step-security/auto-approve-action@v4
```
